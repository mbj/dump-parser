...
I found my self to do this serveral times:
...
* Maintaining this domain knowlege on a per project base.
* Really hate to maintain a dsl free big clumb of sequencial and repeating code.
...
== Example
  ...
  DumpParser.execute :dd_mm_yyyy_date_time, "invalid"     # raises DumpParser::InvalidValueException.new('dd_mm_yyyy_date: value "invalid" is invalid')
  DumpParser.execute :dd_mm_yyyy_date_time, "31.02.2011"  # raises DumpParser::InvalidValueException.new('dd_mm_yyyy_date: value "31.02.2011" is invalid')
